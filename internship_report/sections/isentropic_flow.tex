...
\begin{tikzpicture}[x=1cm,y=1cm,
    ...
    outn/.style={rectangle, draw=green!60!black, thick, fill=green!6, align=center,
                text width=2.2cm, minimum height=0.65cm, font=\small\sffamily},
...
\node[inp] (i1) at (0, 0.9) {Case 2: $T/T_0$ $\to$ explicit};
\node[inp] (i2) at (0, 1.8) {Case 3: $P/P_0$ $\to$ explicit};
\node[inp] (i3) at (0, 2.7) {Case 4: $\rho/\rho_0$ $\to$ explicit};
\node[inp] (i4) at (0, 3.6) {Case 5: $A/A^*$ $\to$ N--R+toggle};
\node[inp] (i5) at (0, 4.5) {Case 6: $\mu$ $\to$ explicit};
\node[inp] (i6) at (0, 5.4) {Case 7: $\nu$ $\to$ Newton--Raphson};
\node[note] (tog) at (4.3, 3.6) {Sub/Sup\\toggle};
%--- Engine ---
...
\node[outn] (o1) at (11.8, 0.9) {$T/T_0$};
\node[outn] (o2) at (11.8, 1.8) {$P/P_0$};
\node[outn] (o3) at (11.8, 2.7) {$\rho/\rho_0$};
\node[outn] (o4) at (11.8, 3.6) {$A/A^*$};
\node[outn] (o5) at (11.8, 4.5) {$\mu$};
\node[outn] (o6) at (11.8, 5.4) {$nu$};
%--- Input arrows ---
