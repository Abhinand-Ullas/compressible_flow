...
\node[inp] (i1) at (0, 1.1) {Case 2: $T/T^*$ $\to$ explicit};
\node[inp] (i2) at (0, 2.2) {Case 3: $P/P^*$ $\to$ explicit};
\node[inp] (i3) at (0, 3.3) {Case 4: $\rho/\rho^*$ $\to$ explicit};
\node[inp] (i4) at (0, 4.4) {Case 5: $P_0/P_0^*$ $\to$ bisection};
\node[inp] (i5) at (0, 5.5) {Case 6: $fL^*/D$ $\to$ bisection};
\node[inp] (i6) at (0, 6.6) {Case 7: $U/U^*$ $\to$ explicit};
\node[note] (t1) at (4.8, 4.4) {Sub/Sup\\toggle};
\node[note] (t2) at (4.8, 5.5) {Sub/Sup\\toggle};
...
\node[outn] (o4) at (12.2, 4.4) {$P_0/P_0^*$};
\node[outn] (o5) at (12.2, 5.5) {$fL^*/D$};
