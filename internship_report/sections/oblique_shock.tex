...
\begin{tikzpicture}[x=1cm,y=1cm,
    case/.style={rectangle, draw=blue!70!black, thick, fill=blue!6, align=center,
                 text width=4.5cm, minimum height=0.85cm, font=\footnotesize\sffamily},
    ...
    outn/.style={rectangle, draw=green!60!black, thick, fill=green!6, align=center,
                text width=2.6cm, minimum height=0.65cm, font=\footnotesize\sffamily},
...
\node[note] (tog) at (4.8, 1.4) {Weak/Strong\\toggle};
\node[eng, minimum height=4.6cm] (eng) at (8.4, 1.4)
    {\textbf{ObliqueShockEngine}\\[3pt]
    \texttt{fromM1Beta}\\($M_1$, $\beta$, $\gamma$)};
\node[outn] (o0) at (12.8, 0.0) {$\theta$};
\node[outn] (o1) at (12.8, 0.9) {$M_2$};
\node[outn] (o2) at (12.8, 1.8) {$T_2/T_1$};
\node[outn] (o3) at (12.8, 2.7) {$P_2/P_1$};
\node[outn] (o4) at (12.8, 3.6) {$\rho_2/\rho_1$};
\node[outn] (o5) at (12.8, 4.5) {$P_{02}/P_{01}$};
