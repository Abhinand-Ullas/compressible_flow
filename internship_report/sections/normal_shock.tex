...
\node[inp] (i1) at (0, 0.9) {Case 2: $M_2$ $\to$ explicit};
\node[inp] (i2) at (0, 1.8) {Case 3: $T_2/T_1$ $\to$ explicit};
\node[inp] (i3) at (0, 2.7) {Case 4: $P_2/P_1$ $\to$ explicit};
\node[inp] (i4) at (0, 3.6) {Case 5: $\rho_2/\rho_1$ $\to$ explicit};
\node[inp] (i5) at (0, 4.5) {Case 6: $P_{02}/P_{01}$ $\to$ N--R};
\node[inp] (i6) at (0, 5.4) {Case 7: $P_{02}/P_1$ $\to$ N--R};
\node[inp] (i7) at (0, 6.3) {Case 8: $\Delta V/a_1$ $\to$ explicit};
\node[eng, minimum height=6.8cm] (eng) at (7.0, 3.15)
    {\textbf{NormalShockEngine}\\[3pt]
    \texttt{fromM1($M_1$,\,$\gamma$)}};
\node[outn] (o0) at (11.8, 0.0) {$M_1$};
\node[outn] (o1) at (11.8, 0.9) {$M_2$};
\node[outn] (o2) at (11.8, 1.8) {$T_2/T_1$};
\node[outn] (o3) at (11.8, 2.7) {$P_2/P_1$};
\node[outn] (o4) at (11.8, 3.6) {$\rho_2/\rho_1$};
\node[outn] (o5) at (11.8, 4.5) {$P_{02}/P_{01}$};
\node[outn] (o6) at (11.8, 5.4) {$P_{02}/P_1$};
\node[outn] (o7) at (11.8, 6.3) {$\Delta V/a_1$};
