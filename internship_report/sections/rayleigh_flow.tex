...
\node[inp] (i1) at (0, 0.9) {Case 2: $T/T^*$ $\to$ explicit+toggle};
\node[inp] (i2) at (0, 1.8) {Case 3: $P/P^*$ $\to$ explicit};
\node[inp] (i3) at (0, 2.7) {Case 4: $\rho/\rho^*$ $\to$ explicit};
\node[inp] (i4) at (0, 3.6) {Case 5: $T_0/T_0^*$ $\to$ explicit+toggle};
\node[inp] (i5) at (0, 4.5) {Case 6: $P_0/P_0^*$ $\to$ bisection};
\node[inp] (i6) at (0, 5.4) {Case 7: $U/U^*$ $\to$ explicit};
\node[note] (t1) at (4.3, 0.9) {Sub/Sup\\toggle};
\node[note] (t2) at (4.3, 3.6) {Sub/Sup\\toggle};
\node[note] (t3) at (4.3, 4.5) {Sub/Sup\\toggle};
\node[eng, minimum height=6.0cm] (eng) at (7.2, 2.7)
    {\textbf{RayleighFlowEngine}\\[3pt]
    \texttt{fromMach(M,\,$\gamma$)}};
\node[outn] (o0) at (12.0, 0.0) {$M$};
\node[outn] (o1) at (12.0, 0.9) {$T/T^*$};
\node[outn] (o2) at (12.0, 1.8) {$P/P^*$};
\node[outn] (o3) at (12.0, 2.7) {$\rho/\rho^*$};
\node[outn] (o4) at (12.0, 3.6) {$T_0/T_0^*$};
\node[outn] (o5) at (12.0, 4.5) {$P_0/P_0^*$};
\node[outn] (o6) at (12.0, 5.4) {$U/U^*$};
